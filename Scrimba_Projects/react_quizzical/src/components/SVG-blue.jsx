...
export default function SVG_Blue() {

  return (
    <svg aria-hidden="true" className="blob-blue" width="300" height="200" viewBox="0 0 148 118" fill="none" xmlns="http://www.w3.org/2000/svg">
