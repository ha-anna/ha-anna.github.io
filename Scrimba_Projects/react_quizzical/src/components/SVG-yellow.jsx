...
export default function SVG_Yellow() {

  return (
    <svg aria-hidden="true" className="blob-yellow" width="300" height="200" viewBox="0 0 158 141" fill="none" xmlns="http://www.w3.org/2000/svg">
